<p align="center">
  ...
  <p align="center"> 
    <a href="https://github.com/needinc/dicom/actions"><img src="https://github.com/needinc/dicom/workflows/build/badge.svg" /></a> 
    <a href="https://godoc.org/github.com/needinc/dicom"><img src="https://godoc.org/github.com/needinc/dicom?status.svg" alt="" /></a>
    <a href="https://goreportcard.com/report/github.com/needinc/dicom"><img src="https://goreportcard.com/badge/github.com/needinc/dicom" alt=""></a> 
  </p>
</p>
...
## Usage
To use this in your golang project, import `github.com/needinc/dicom`. This repository supports Go modules, and regularly tags releases using semantic versioning. Typical usage is straightforward:
```go 
...
fmt.Println(j)
```
More details about the package (and additional examples and APIs) can be found in the [godoc](https://godoc.org/github.com/needinc/dicom).
...
### Installation
You can download the prebuilt binaries from the [releases tab](https://github.com/needinc/dicom/releases), or use the following to download the binary at the command line using my [getbin tool](https://github.com/needinc/getbin):
